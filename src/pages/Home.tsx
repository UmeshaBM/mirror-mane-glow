        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl text-white">
            ...
            <p className="text-xl md:text-2xl mb-8 text-white/90 fade-in">
              Where Beauty Meets Excellence. Experience luxury hair and beauty
              services in our premium salon.
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Discover our range of professional beauty and hair services
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {services.map((service, index) => (
              <Card
                key={index}
                className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-2 glass"
              >
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-secondary text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
            Book your appointment today and experience the luxury and quality
            that sets us apart.
          </p>
